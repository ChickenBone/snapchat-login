...
"resource": {
  ...
  "rules":[
    ...
    [["if",2,18,19,42],["add",20]],
    [["if",2,18,19,43,44],["add",21]],
    [["if",2,18,19,45],["add",22]],
    [["if",8,18,19,40,46],["add",23,24,30]],
    [["if",2,18,19,42,46],["add",25,43,47]],
    [["if",2,18,19,41,46],["add",25,43,47]],
    [["if",2,18,19,46,47],["add",25,43,47]],
    [["if",2,18,19,43,46,48],["add",26,44,48]],
    [["if",2,18,19,45,46],["add",27,45]],
    [["if",2,18,19,47],["add",28]],
    [["if",2,18,19,49],["add",29,49]],
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-KZM6MXH";Vc.Cb="3i0";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var ad=Zc,bd=null,cd=null,dd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=96",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
Z.a.f=["google"],function(){(function(a){Z.__f=a;Z.__f.b="f";Z.__f.g=!0;Z.__f.priorityOverride=0})(function(a){var b=U("gtm.referrer",1)||G.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?$e(af(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):ek(String(b)):String(b)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return hk(a.vtp_name,U("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
d.vtp_trackType){}else if("TRACK_TIMING"==d.vtp_trackType){var P={hitType:"timing",timingCategory:String(d.vtp_timingCategory||e.category),timingVar:String(d.vtp_timingVar||e.name),timingValue:za(d.vtp_timingValue||e.value),timingLabel:y(String,d.vtp_timingLabel||e.label)};A(K,P,!1);x("send",P);}else if("DECORATE_LINK"==
